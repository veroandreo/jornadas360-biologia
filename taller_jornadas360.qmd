...
3. Asignar: Rojo = `Banda 3` (B4_pre), Verde = `Banda 2` (B3_pre), Azul = `Banda 1` (B2_pre).
4. Click en **Aceptar**.
...
5. Repetir el procedimiento para las siguientes fórmulas:
  * **NDVI Post-fuego:** `("Banda 4" - "Banda 3") / ("Banda 4" + "Banda 3")`
...
3. Selección la capa reclasificada.
